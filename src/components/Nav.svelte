...
>
	...
	<div class="flex items-center space-x-4">
		<!-- RSS -->
		<!-- <a
			class="rounded-lg text-gray-700 hover:bg-yellow-400 dark:text-gray-200 dark:hover:bg-yellow-800"
			rel="external"
		...
		<!-- Github -->
		<!-- <a
			class="rounded-lg text-gray-700 hover:bg-yellow-400 dark:text-gray-200
		...
		<!-- Twitter -->
		<a
			href="https://twitter.com/fab_rosato"
			title="twitter"
			target="_blank"
			rel="me noopener"
			class="rounded-lg text-gray-700 hover:bg-yellow-400 dark:text-gray-200 dark:hover:bg-yellow-800"
